...
if (isset($_POST['btn'])) {
    ...
    $obj = new admin();
    $message=$obj->admin_login_check($_POST);
}
?>
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <h2 style="color: #960004;"><?php if(isset($message)){echo $message;} ?>
                        <form class="form-horizontal" action="" method="post">
                            <fieldset>

                                <div class="input-prepend" title="Email Address">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" name="email_address" id="username" type="email" placeholder="type You Email Addresss" />
                                </div>
